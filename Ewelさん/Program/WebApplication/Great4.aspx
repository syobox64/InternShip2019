...
<%@ Page Title="キャンペーンページ" Language="C#" MasterPageFile="~/RuritoSite.master" AutoEventWireup="true"
    CodeBehind="Great4.aspx.cs" Inherits="WebApplication._Great4" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div style="background-color:#ffffbc;font size="30";>
        ...
        <h2 style="margin:1.0em 2em;background: #dfefff;box-shadow: 0px 0px 0px 5px #dfefff; border: dashed 1px #96c2fe; padding: 0.2em 0.5em; color: #454545;" >100コインゲット(^^)/</h2>
        <div  align="center">
